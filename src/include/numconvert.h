...
/// @param buffer The buffer to write the number to (MUST BE ENOUGH SPACE, USE GET_MAX_CHARS_BASE_SIGN TO GET THE MAX CHARS)
...
/// @brief Convert a unsigned number into a buffer.
/// @param num The number to convert
...
#define GET_MAX_CHARS_BASE_SIGN(base) (sizeof(int) * 8 / (base == 10 ? 3 : 4) + 2)
#define GET_MAX_CHARS_BASE(base) (sizeof(int) * 8 / (base == 10 ? 3 : 4) + 1)
