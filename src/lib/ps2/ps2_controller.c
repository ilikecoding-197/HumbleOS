...
int ps2_controller_init() {
	...
	klog("PS2_CTRL", "updating configuration byte...");
	...
	klog("PS2_CTRL", "testing for two channels...");
	...
	klog("PS2_CTRL", "performing tests...");
	...
	klog("PS2_CTRL", "CONTROLLER IS WORKING!");
